...
Nim's implementation of lists is called _sequences_ and they can be created very simply. Sequences always start index at 0. Meaning we lose our weirdly indexed arrays if we turn them into sequences :(
...
We can now create new Person objects with a name and a birthyear similar to how it's done in other languages. In the below example we create a Person object for _pepe_:
